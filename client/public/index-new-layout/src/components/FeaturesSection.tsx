import { Brain, BarChart3, Users, Zap, Shield, Rocket } from 'lucide-react';
        ...
        <div className="mt-16">
          <div className="glass-card max-w-4xl mx-auto p-8 relative overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              <div className="w-20 h-20 bg-gradient-to-br from-purple-500 to-blue-500 rounded-full p-5 mx-auto mb-6 animate-glow-pulse">
