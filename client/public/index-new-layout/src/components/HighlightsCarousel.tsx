  ...
  return (
    <section className="relative h-24 w-full overflow-hidden bg-gradient-to-r from-background/50 via-primary/10 to-background/50 border-y border-gold/20">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute top-6 right-1/3 w-1 h-1 bg-silver rounded-full animate-bounce-slow"></div>
        <div className="absolute bottom-4 left-1/2 w-1.5 h-1.5 bg-primary rounded-full animate-glow-pulse"></div>
      </div>
