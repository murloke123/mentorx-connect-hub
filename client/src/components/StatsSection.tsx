import { BookOpen, Clock, DollarSign, Star, TrendingUp, Users } from 'lucide-react';
    ...
    <section className="py-20 relative overflow-hidden bg-background">
      ...
      <div className="absolute inset-0">
        ...
        {[...Array(30)].map((_, i) => (
          <div
            key={i}
            className="absolute w-1 h-1 bg-gold rounded-full float opacity-30"
            style={{
            ...
            return (
              ...
              >
                <div className="text-center">
                  ...
                  {/* Stats */}
                  <div className="mb-4">
                    <div className="text-4xl md:text-5xl font-black gradient-text mb-2 glow-pulse">
                      {stat.value}
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gold/10 to-transparent -skew-x-12 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </div>
            );
          })}
        </div>
