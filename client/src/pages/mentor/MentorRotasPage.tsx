...
const RoutesVisualizationPage = () => {
  ...
  const routes: RouteInfo[] = [
    ...
    { path: "/mentor/meus-cursos", component: "MeusCursosPage", section: "Mentor", hasParams: false, referencedBy: ["MentorSidebar"] },
    { path: "/mentor/meus-cursos/novo", component: "CreateCoursePage", section: "Mentor", hasParams: false, referencedBy: ["MeusCursosPage"] },
    { path: "/mentor/meus-cursos/:id/editar", component: "EditCoursePage", section: "Mentor", hasParams: true, referencedBy: ["MeusCursosPage"] },
    { path: "/mentor/meus-cursos/view/:id", component: "CoursePlayerPage", section: "Mentor", hasParams: true, referencedBy: ["MeusCursosPage"] },
    { path: "/mentor/meus-cursos/:cursoId/modulos", component: "ModulosPage", section: "Mentor", hasParams: true, referencedBy: ["MeusCursosPage"] },
    { path: "/mentor/meus-cursos/:cursoId/modulos/:moduloId", component: "ConteudosPage", section: "Mentor", hasParams: true, referencedBy: ["ModulosPage"] },
