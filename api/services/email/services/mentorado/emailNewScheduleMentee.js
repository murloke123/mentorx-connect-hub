...
exports.sendNewScheduleEmailToMentee = sendNewScheduleEmailToMentee;
exports.testNewScheduleEmailToMentee = testNewScheduleEmailToMentee;
const brevo = __importStar(require("@getbrevo/brevo"));
const brevoClient_1 = __importStar(require("../../config/brevoClient"));
const emailNewScheduleMentee_1 = require("../../templates/mentorado/emailNewScheduleMentee");
/**
 * Envia email de confirmação de agendamento para o mentorado
 */
async function sendNewScheduleEmailToMentee(data) {
    try {
        ...
        let htmlContent = emailNewScheduleMentee_1.emailNewScheduleMenteeTemplate.htmlContent;
        let textContent = emailNewScheduleMentee_1.emailNewScheduleMenteeTemplate.textContent || '';
        let subject = emailNewScheduleMentee_1.emailNewScheduleMenteeTemplate.subject;
 ...
 */
async function testNewScheduleEmailToMentee(testEmail) {
    const testData = {
