...
async function registerRoutes(app) {
    ...
    // ##########################################################################################
    // ENDPOINT: Health check adicional (migrado de routes.js)
    ...
    app.post('/api/stripe/account', async (req, res) => {
        try {
            ...
            const { createOrUpdateStripeConnectedAccount } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerClientService')));
    ...
    app.get('/api/stripe/account/:accountId/status', async (req, res) => {
        try {
            ...
            // Importar dinamicamente o serviço
            const { verifyStripeAccountStatus } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerClientService')));
    ...
    app.post('/api/stripe/documents/upload', async (req, res) => {
        try {
            ...
            const { uploadDocumentToStripe } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerDocumentService')));
    ...
    app.post('/api/stripe/documents/associate', async (req, res) => {
        try {
            ...
            // Importar dinamicamente o serviço de documentos
            const { associateDocumentToAccount } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerDocumentService')));
    ...
    app.get('/api/stripe/documents/status/:accountId', async (req, res) => {
        try {
            ...
            // Importar dinamicamente o serviço de documentos
            const { checkAccountVerificationStatus } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerDocumentService')));
    ...
    app.post('/api/stripe/products', async (req, res) => {
        try {
            ...
            const { createStripeProduct } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerProductService')));
    ...
    app.get('/api/stripe/products/:accountId', async (req, res) => {
        try {
            ...
            // Importar dinamicamente o serviço de produtos
            const { listStripeProducts } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerProductService')));
            const options = {};
            if (active !== undefined)
    ...
    app.get('/api/stripe/products/:accountId/:productId', async (req, res) => {
        try {
            ...
            // Importar dinamicamente o serviço de produtos
            const { getStripeProduct } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerProductService')));
    ...
    app.put('/api/stripe/products/:accountId/:productId', async (req, res) => {
        try {
            ...
            // Importar dinamicamente o serviço de produtos
            const { updateStripeProduct } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerProductService')));
    ...
    app.delete('/api/stripe/products/:accountId/:productId', async (req, res) => {
        try {
            ...
            // Importar dinamicamente o serviço de produtos
            const { deleteStripeProduct } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerProductService')));
    ...
    app.post('/api/stripe/prices', async (req, res) => {
        try {
            ...
            // Importar dinamicamente o serviço de produtos
            const { createStripePrice } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerProductService')));
    ...
    app.get('/api/stripe/products/:accountId/:productId/prices', async (req, res) => {
        try {
            ...
            // Importar dinamicamente o serviço de produtos
            const { listStripePrices } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerProductService')));
            const options = {};
            if (active !== undefined)
                options.active = active === 'true';
    ...
    app.get('/api/stripe/prices/:accountId/:priceId', async (req, res) => {
        try {
            ...
            // Importar dinamicamente o serviço de produtos
            const { getStripePrice } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerProductService')));
    ...
    app.delete('/api/stripe/prices/:accountId/:priceId', async (req, res) => {
        try {
            ...
            // Importar dinamicamente o serviço de produtos
            const { deactivateStripePrice } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerProductService')));
    ...
    app.get('/api/stripe/test', async (req, res) => {
        try {
            ...
            const { config } = await Promise.resolve().then(() => __importStar(require('./environment')));
    ...
    app.post('/api/stripe/appointments/checkout', async (req, res) => {
        try {
            const { priceId, buyerId, buyerEmail, mentorId, mentorStripeAccountId, appointmentData, stripeProductId, successUrl, cancelUrl } = req.body;
            ...
            const { createStripeCheckoutSession } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerCheckoutService')));
            // Criar registro inicial da transação no banco
            const supabase = (await Promise.resolve().then(() => __importStar(require('@supabase/supabase-js')))).createClient(process.env.SUPABASE_URL, process.env.SUPABASE_SERVICE_ROLE);
    ...
    app.post('/api/stripe/appointments/verify-payment', async (req, res) => {
        try {
            ...
            const supabase = (await Promise.resolve().then(() => __importStar(require('@supabase/supabase-js')))).createClient(process.env.SUPABASE_URL, process.env.SUPABASE_SERVICE_ROLE_KEY);
            const { data: transaction, error: transactionError } = await supabase
                .from('stripe_connect_transactions')
                .select('*')
            ...
            const { verifyStripeCheckoutSession } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerCheckoutService')));
            const stripeResult = await verifyStripeCheckoutSession(transaction.stripe_account_id, sessionId);
    ...
    app.get('/api/stripe/checkout/payment/:accountId/:paymentIntentId', async (req, res) => {
        try {
            ...
            // Importar dinamicamente o serviço de checkout
            const { verifyStripePaymentStatus } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerCheckoutService')));
    ...
    app.get('/api/stripe/checkout/sessions/:accountId', async (req, res) => {
        try {
            ...
            // Importar dinamicamente o serviço de checkout
            const { listStripeCheckoutSessions } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerCheckoutService')));
            const options = {};
            if (limit !== undefined)
                options.limit = parseInt(limit);
    ...
    app.post('/api/stripe/verify-balance', async (req, res) => {
        ...
        try {
            ...
            const { verifyConnectedAccountBalance } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerVerifyBalanceService')));
    ...
    app.post('/api/stripe/verify-payouts', async (req, res) => {
        try {
            ...
            const { verifyConnectedAccountPayouts } = await Promise.resolve().then(() => __importStar(require('./services/stripeServerVerifyPayoutsService')));
    ...
    const processedWelcomeEmails = new Map();
    ...
    app.post('/api/email/boas-vindas', async (req, res) => {
        ...
        try {
            ...
            const { enviarEmailBoasVindas } = await Promise.resolve().then(() => __importStar(require('./services/email/emailService')));
            const emailData = {
                userName,
                userEmail,
                userRole: userRole,
    ...
    app.get('/api/email/test', async (req, res) => {
        try {
            ...
            // Importar dinamicamente o serviço de e-mail
            const { testarConectividadeBrevo } = await Promise.resolve().then(() => __importStar(require('./services/email/emailService')));
    ...
    app.post('/api/calendar/test-email', async (req, res) => {
        try {
            const { mentorName, menteeName, menteeEmail, appointmentDate, appointmentTime, cancellationReason } = req.body;
            ...
            const { enviarEmailCancelamentoAgendamento } = await Promise.resolve().then(() => __importStar(require('./services/email/services/mentor/emailCalendarCancel')));
            const emailData = {
    ...
    app.post('/api/calendar/cancel-email', async (req, res) => {
        try {
            const { appointmentId, mentorName, menteeName, appointmentDate, appointmentTime, cancellationReason } = req.body;
    ...
    app.post('/api/calendar/new-appointment-email', async (req, res) => {
        try {
            const { mentorId, mentorName, menteeName, appointmentDate, appointmentTime, timezone, notes, meetLink } = req.body;
            ...
            const { enviarEmailNovoAgendamento } = await Promise.resolve().then(() => __importStar(require('./services/email/services/mentor/emailNewSchedule')));
    ...
    app.post('/api/calendar/new-appointment-email/debug-html', async (req, res) => {
        try {
            ...
            const { newScheduleTemplate } = await Promise.resolve().then(() => __importStar(require('./services/email/templates/mentor/newScheduleTemplate')));
    ...
    app.post('/api/calendar/new-appointment-email/mentee', async (req, res) => {
        try {
            const { menteeId, mentorName, menteeName, menteeEmail, appointmentDate, appointmentTime, timezone, notes, meetLink } = req.body;
            ...
            const { sendNewScheduleEmailToMentee } = await Promise.resolve().then(() => __importStar(require('./services/email/services/mentorado/emailNewScheduleMentee')));
    ...
    app.post('/api/calendar/new-appointment-email/mentee/test', async (req, res) => {
        try {
            ...
            const { testNewScheduleEmailToMentee } = await Promise.resolve().then(() => __importStar(require('./services/email/services/mentorado/emailNewScheduleMentee')));
    ...
    app.post('/api/calendar/cancel-email/debug-html', async (req, res) => {
        try {
            ...
            const { calendarCancelTemplate } = await Promise.resolve().then(() => __importStar(require('./services/email/templates/mentor/calendarCancelTemplate')));
    ...
    app.post('/api/calendar/new-appointment-email/mentee/basic', async (req, res) => {
        try {
            ...
            const { sendNewScheduleEmailToMenteeBasic } = await Promise.resolve().then(() => __importStar(require('./services/email/services/mentorado/emailNewScheduleMenteeBasic')));
    ...
    app.post('/api/email/contact-mentor', async (req, res) => {
        try {
            ...
            const { enviarEmailParaMentor } = await Promise.resolve().then(() => __importStar(require('./services/email/services/mentor/emailSendToMentor')));
            const emailData = {
                mentorName,
                mentorEmail,
                senderName,
    ...
    app.post('/api/email/course-buy', async (req, res) => {
        ...
        try {
            ...
            const { enviarEmailVendaCurso } = await Promise.resolve().then(() => __importStar(require('./services/email/services/mentor/emailSendCourseBuy')));
            const emailData = {
                mentorName,
                mentorEmail,
                buyerName,
    ...
    const JitsiMeetService = (await Promise.resolve().then(() => __importStar(require('./services/JitsiMeetService')))).default;
