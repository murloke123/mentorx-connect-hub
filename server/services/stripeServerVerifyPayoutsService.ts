 ...
 */
async function verifyConnectedAccountPayouts(connectedAccountId: string): Promise<PayoutsResult> {
  try {
    ...
    balanceTransactions.data.forEach((transaction: any) => {
