 ...
 */
const logToNetworkChrome = async (action: string, input: any, output?: any, error?: any) => {
  try {
    const logData = {
 ...
 */
export async function uploadDocumentToStripe(
 ...
 */
export async function associateDocumentToAccount(
  accountId: string,
  fileId: string,
 ...
 */
export async function checkAccountVerificationStatus(accountId: string) {
